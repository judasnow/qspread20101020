...
require_once 'Vi/View/RegisterBroker.php';
...
class Vi_View implements Zend_View_Interface
{
    /**
     * Instance of Smarty
     * @var Smarty
    ...
    public $smarty;
    /**
     * Instance of Vi_View_RegisterBroker
     * @var Vi_View_RegisterBroker
     */
    public $helper;
    /*
    ...
    public function __construct ($tmplPath = null, $extraParams = array())
    {
        ...
        $this->helper = new Vi_View_RegisterBroker($this->smarty);
        if (null !== $tmplPath) {
     ...
     * @return void
     */
    public function setBasePath ($path, $prefix = 'Vi_View')
    {
