...
--
-- Host: localhost
-- Generation Time: Dec 09, 2010 at 07:55 AM
...
(2, 'Restaurant Owner', 0, NULL, '#0000ff', NULL, 0, 3),
...
(5, 'meal_order', '[SUB_TOTAL]<br/>[SALES_TAX]<br/>[SHIPPING_FEE]<br/>[ORDER_TOTAL]<br/>[FULL_NAME]<br/>[ADDRESS]<br/>[SUITE]<br/>[CITY]<br/>[STATE]<br/>[ZIP_CODE]<br/>[PHONE]<br/>[EMAIL]<br/>[CARD_TYPE]<br/>[CARD_NUMBER]<br/>[CARD_DETAIL]', 1, 1);
...
(5, 5, 1, 'Finished payment', '<p>\r\n	Hi <strong>[FULL_NAME]</strong>,<br />\r\n	<br />\r\n	Thank you very much for your payment. We are preparing your meals.</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	Following is your order:</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	[CARD_DETAIL]</p>\r\n<p>\r\n	<br />\r\n	<br />\r\n	QuickSpread.com</p>\r\n', 1);
...
INSERT INTO `vi_meal` (`meal_id`, `name`, `description`, `price`, `parent`, `restaurant_id`, `category_value_id`, `type`, `image`, `enabled`, `created_date`) VALUES
(1, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 0.75, 0, 1, 1, 0, NULL, 1, NULL),
(2, 'Fire Roasted Vegetable  ', 'Fire Roasted Vegetable\r\n ', 3.5, 1, 1, 1, 0, NULL, 1, NULL),
(3, 'Chicken Tortilla Soup', ' Served with sour cream and chips.', 3.5, 1, 1, 1, 0, NULL, 1, NULL),
(4, 'Amy''s Special Recipe Chili', ' Served with two kinds of cheese and fresh baked bread.', 3.59, 1, 2, 1, 0, NULL, 1, NULL),
...
DROP TABLE IF EXISTS `vi_order_detail`;
...
INSERT INTO `vi_order_detail` (`order_detail_id`, `meal_id`, `order_id`, `name`, `description`, `quantity`, `price`, `total`) VALUES
(1, 1, 1, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 1, 0.75, 0.75),
(2, 1, 2, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 1, 0.75, 0.75),
(3, 1, 3, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 1, 0.75, 0.75),
(4, 2, 3, 'Fire Roasted Vegetable  ', 'Fire Roasted Vegetable\r\n ', 1, 3.5, 3.5),
(5, 1, 4, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 1, 0.75, 0.75),
(6, 2, 4, 'Fire Roasted Vegetable  ', 'Fire Roasted Vegetable\r\n ', 1, 3.5, 3.5),
(7, 1, 5, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 1, 0.75, 0.75),
(8, 2, 5, 'Fire Roasted Vegetable  ', 'Fire Roasted Vegetable\r\n ', 1, 3.5, 3.5),
(9, 1, 6, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 1, 0.75, 0.75),
(10, 1, 7, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 1, 0.75, 0.75),
(11, 1, 8, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 2, 0.75, 1.5),
(12, 1, 9, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 3, 0.75, 2.25),
(13, 1, 10, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 2, 0.75, 1.5),
(14, 1, 11, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 2, 0.75, 1.5),
(15, 1, 12, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 2, 0.75, 1.5),
(16, 1, 13, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 2, 0.75, 1.5),
(17, 1, 14, 'Homemade Soup', 'Served with our fresh baked bread or add a bread bowl for 0.75.', 2, 0.75, 1.5),
...
(1, 'Apple Spice Junction - Audubon', NULL, 'Apple Spice Junction offers box lunch delivery, corporate catering and deli dining. Sandwich selections feature freshly-baked breads, fine meats and cheeses and crisp vegetables. Homemade soups, healthy salads and fresh bakery treats round out the box lunch menu, while breakfast offerings range from pastries and fruit to gourmet eggs and seasoned potatoes. Whether you need a caterer for a business event or family party, or just want to stop in for a sandwich and a bowl of soup, Apple Spice Junction means "good food when you need it."', '', '2', '123 Lac Long Quan', 'Ho Chi Minh', 'New Brunswick', '12345', 'Nguyen Hoai Tan', '1234567890', '1234567890', 'Johny Nguyen', '1234567890', 'test@test.com', 1.15, '45 min', NULL, NULL, '1 day', NULL, 50, 15, 0, NULL, NULL, 0, 'Catering- Delivery,Delivery', 'media/userfiles/images/restaurant/Apple-Spice.gif', 1, '00:00', '86340', 0, NULL, NULL, 0, NULL, NULL, 0, '08:00', '22:00', 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 1, NULL, 1),
(2, 'Xpress Pizza and Grill', NULL, 'We serve Phoenixville and surrounding areas with the best pizza in town, made with fresh ingredients. Our menu also include a variety of delicious choices such as Stromboli, Quesadilla, Sandwiches and Appetizers, with something for everyone.', 'hoaitan.com', '1', '123 Lac Long Quan', 'Ho Chi Minh', 'Newfoundland', '12345', 'Nguyen Hoai Tan', '1234567890', '1234567890', 'Johny Nguyen', '1234567890', 'test@test.com', 4.52, '20 min', NULL, NULL, '6 hours', NULL, 15, 2, 0, NULL, NULL, 0, 'Delivery,Catering- Delivery', 'media/userfiles/images/restaurant/img.jpg', 1, '00:00', '86340', 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 1, NULL, 1),
(5, 'Vietnamese Pho', NULL, NULL, 'hoaitan.com', '3', '123 Street', 'Ho Chi Minh', 'Alberta', '1234', 'Nguyen Hoai Tan', '1234567890', '1234567890', 'Nguyen Hoai Tan', '1234567890', 'nguoiao007@gmail.com', NULL, '10 min', '15 min', '20 min', '30 min', '1 hour', 30, 10, 1, 40, 10, 1, NULL, 'media/userfiles/images/restaurant/Apple-Spice.gif', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, 1290825697, 1),
(11, 'Vietnamese Rice', NULL, NULL, 'hoaitan.com', '50', '123 Lac Long Quan', 'Ho Chi Minh', 'Yukon Territory', '12345', 'Nguyen Hoai Tan', '1234567890', '1234567890', 'Nguyen Hoai Tan', '1234567890', 'nguoiao007@gmail.com', NULL, '10 min', '15 min', '30 min', NULL, NULL, 50, 10, 0, NULL, NULL, 0, NULL, 'media/userfiles/images/restaurant/img.jpg', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, '08:00', '20:00', 1, 1291139893, 1);
...
(1, 1, 1, 0, 0, 21, 1289536365, 'front2'),
(2, 1, 1, 0, 0, 20, 1289550663, 'front2'),
(3, 1, 1, 0, 0, 19, 1289551148, 'front2'),
(4, 1, 1, 0, 0, 18, 1289551786, 'front'),
(5, 1, 1, 0, 0, 17, 1289551897, 'front'),
(6, 1, 1, 0, 0, 16, 1289552025, 'front2'),
(7, 1, 1, 0, 0, 15, 1289552144, 'front2'),
(8, 1, 1, 0, 0, 14, 1289552229, 'front2'),
(9, 1, 1, 0, 0, 13, 1289552364, 'front2'),
(10, 1, 1, 0, 0, 12, 1289850430, 'front'),
(11, 1, 1, 0, 0, 11, 1289861527, 'front'),
(13, 1, 1, 0, 0, 9, 1289928772, 'front'),
(14, 1, 1, 0, 0, 8, 1289928925, 'front'),
(15, 1, 1, 0, 0, 7, 1289928971, 'front'),
(16, 1, 1, 0, 0, 6, 1289929660, 'front'),
(17, 1, 1, 0, 0, 5, 1289930810, 'front'),
(18, 1, 1, 0, 0, 4, 1289931432, 'front'),
(19, 1, 1, 0, 0, 3, 1290755509, 'front'),
(20, 1, 1, 0, 0, 2, 1290757965, 'front2'),
(21, 1, 1, 0, 0, 1, 1291016822, 'front');
...
(31, 21, 1, 1, 'Finished Payment', '', 'finished-payment', 'finished-payment', '', '<p>\r\n	<span style="font-size: 16px;"><span style="color: rgb(128, 0, 0);"><strong>Finished payment</strong></span></span></p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	Thank you very much for you payment. We are preparing your meals.</p>\r\n<p>\r\n	&nbsp;</p>\r\n<p>\r\n	See you next time,</p>\r\n<p>\r\n	QuickSpread.com</p>\r\n', 0, 0, NULL, NULL);
...
(1, 1, 'admin', 'nguoiao007@gmail.com', 'Admin', 'e10adc3949ba59abbe56e057f20f883e', 1284310752, 1, 1291345036, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(5, 3, 'hoaitan', 'hoaitan_it@yahoo.com', 'Nguyen Hoai Tan', 'e40880fd26194bedaa390ea7a0b3c4e7', 1289861130, 1, 1291371891, NULL, 'Hoaitan', 'Lac Long Quan', '123', 'Ho Chi Minh', 'British Columbia', '12345', '123', '456', '7890', 2, 12, 1987, 1, 52, 'Ho Chi Minh', 1),
