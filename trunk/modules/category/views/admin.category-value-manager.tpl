                ...
                <div class="content-box-header">
                   ...
                   <div style="float:right;padding-right:20px;padding-top:5px;">
                        <form class="search" name="search" method="post" action="{{$APP_BASE_URL}}category/admin/category-value-manager/id/{{$category.category_id}}">
                          ...
                          Value:  <input class="text-input small-input" type="text" name="condition[name]" id="categoryValuename" value="{{$condition.name}}"/>
                        ...
                        <table>
                            <thead>
                                <tr>
                                   ...
                                   <th>ID</th>
                                   <th>Value</th>
                                   <th class="center">Sort <a href="javascript:document.sortForm.submit();"><img src="{{$LAYOUT_HELPER_URL}}admin/images/icons/save_16.png"></img></a></th>
