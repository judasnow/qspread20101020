            ...
            <div class="content-box"><!-- Start Content Box -->
                ...
                <div class="content-box-header">
                   ...
                   <div style="float:right;padding-right:20px;padding-top:5px;">
                        <form class="search" name="search" method="post" action="{{$APP_BASE_URL}}restaurant/admin/pending">
                        ...
                        <table>
                            ...
                            {{foreach from=$allRestaurants item=item}}
                                <tr>
                                    ...
                                    <td class="center">
                                        <!-- Icons -->
                                         <a href="{{$APP_BASE_URL}}restaurant/admin/edit/id/{{$item.restaurant_id}}" title="View & Approve"><img src="{{$LAYOUT_HELPER_URL}}admin/images/icons/approve_16.png"  alt="View & Approve" /></a>
...
function deleteRestaurant()
{
    ...
    window.location.href = '{{$APP_BASE_URL}}restaurant/admin/delete-pending/id/' + tmp;
}
...
function deleteARestaurant(id)
{
    ...
    window.location.href = '{{$APP_BASE_URL}}restaurant/admin/delete-pending/id/' + id;
}
</script>
