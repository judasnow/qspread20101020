...
require_once 'Shared/Models/Permission.php';
require_once 'Shared/Models/GroupPermission.php';
class permission_AdminController extends Vi_Controller_Action_Admin 
{
...
//        echo '<pre>';print_r($allPers);die;
    ...
    public function rescanAction()
    {
        ...
        $this->session->permissionMessage = array(
                                           'success' => true,
                                           'message' => Vi_Language::translate('Rescan all permission rules successfully')
                                       );
    ...
    public function enablePermissionAction()
    {
        ...
        if ('*' == $expandId) {
             ...
             * Normal permission
             */
            $groupper = $objGroupPer->getByColumnName(array(
                                                            'group_id=?' => $groupId,
