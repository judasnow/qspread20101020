                            ...
                            <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                ...
                                <p>
                                    <label>Name<span class="red">*</span></label>
                                        <input class="text-input small-input" type="text" id="small-input" name="data[name]" value="{{$data.name}}" />{{if $errors.name}}<span class="input-notification error png_bg">{{$errors.name}}</span>{{/if}}
                                </p>
                                <p>
                                    <label>Color<span class="red">*</span></label>
                                        <input class="text-input small-input" type="text" id="small-input" name="data[color]" value="{{$data.color}}" />{{if $errors.color}}<span class="input-notification error png_bg">{{$errors.color}}</span>{{/if}}
                                </p>
                                <p>
                                    <label>Sorting<span class="red">*</span></label>
                                        <input class="text-input small-input" type="text" id="small-input" name="data[sorting]" value="{{$data.sorting}}" />{{if $errors.sorting}}<span class="input-notification error png_bg">{{$errors.sorting}}</span>{{/if}}
                                </p>
                                <p>
