            ...
            <div class="content-box"><!-- Start Content Box -->
                ...
                <div class="content-box-header">
                    ...
                    <ul class="content-box-tabs">
                        <li><a href="#tab0" {{if false==$lid}}class="default-tab"{{/if}}>General</a></li>
                    ...
                    <div class="tab-content {{if false!=$lid}}hidden{{/if}}" id="tab0">
                        ...
                        {{/if}}
                            ...
                            <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                ...
                                <p>
                                    <label>Enable<span class="red">*</span></label>
                    ...
                    <div class="tab-content {{if $item.lang_id!=$lid}}hidden{{/if}}" id="tab{{$item.lang_id}}">
                        ...
                        <div>
                            ...
                            <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                ...
                                <p>
                                    <b>Subject</b><br/>
                                        <input class="text-input small-input" type="text" id="small-input" name="data[{{$item.lang_id}}][subject]" value="{{$data[$item.lang_id].subject}}" />
                                </p>
                                <p>
                                    <b>Content</b>
