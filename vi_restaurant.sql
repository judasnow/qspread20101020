...
--
-- Host: localhost
-- Generation Time: Oct 26, 2010 at 02:09 PM
...
CREATE TABLE IF NOT EXISTS `vi_restaurant` (
  ...
  `curbside` varchar(255) DEFAULT NULL,
  `catering_pickup_only` varchar(255) DEFAULT NULL,
