                    ...
                    <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                        ...
                        <div class="bulk-actions align-left" style="float: left;padding-top: 14px;">
                            <select id="action">
                                ...
                                <option value="enableGroup();">Enable</option>
                                <option value="disableGroup();">Disable</option>
                            </select>
                        ...
                        <div class="bulk-actions align-left" style="float: left;padding-top: 10px; padding-left:30px;">
                            <form class="search" name="search" method="post" action="{{$APP_BASE_URL}}user/admin/group-manager">
                                Display #
