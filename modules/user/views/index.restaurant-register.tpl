            <div class="bg_howitwork">
                ...
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Mon:<span class="red">*</span></label>
                <input type="text" value="8:00am" class="w50"/> - <input type="text" value="20:00pm" class="w50" />
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Tue:<span class="red">*</span></label>
                <input type="text" value="8:00am" class="w50"/> - <input type="text" value="20:00pm" class="w50" /> <input type="checkbox" class="mid m20l" style="border:none;" /> Same as above
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Wed:<span class="red">*</span></label>
                <input type="text" value="8:00am" class="w50"/> - <input type="text" value="20:00pm" class="w50" /> <input type="checkbox" class="mid m20l" style="border:none;" /> Same as above
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Thus:<span class="red">*</span></label>
                <input type="text" value="8:00am" class="w50"/> - <input type="text" value="20:00pm" class="w50" /> <input type="checkbox" class="mid m20l" style="border:none;" /> Same as above
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Fri:<span class="red">*</span></label>
                <input type="text" value="8:00am" class="w50"/> - <input type="text" value="20:00pm" class="w50" /> <input type="checkbox" class="mid m20l" style="border:none;" /> Same as above
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Sat:<span class="red">*</span></label>
                <input type="text" value="8:00am" class="w50"/> - <input type="text" value="20:00pm" class="w50" /> <input type="checkbox" class="mid m20l" style="border:none;" /> Same as above
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Sun:<span class="red">*</span></label>
                <input type="text" value="8:00am" class="w50"/> - <input type="text" value="20:00pm" class="w50" /> <input type="checkbox" class="mid m20l" style="border:none;" /> Same as above
                <br style="clear:both;"/>
                ...
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Pickup</label>
                    <span class="rsu-info" style="display: inline;"> - Lead Time: <select id="ctl00_cBody_ddlPickupLead" name="ctl00$cBody$ddlPickupLead">
                ...
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Curbside</label>
                <span class="rsu-info" style="display: inline;"> - Lead Time: <select id="ctl00_cBody_ddlPickupLead" name="ctl00$cBody$ddlPickupLead">
                    <option value="17">10 min</option>
                    <option value="1">15 min</option>
                    <option value="18">20 min</option>
                ...
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Delivery</label>
                
                <span class="rsu-info" style="display: inline;"> - Lead Time: <select id="ctl00_cBody_ddlDeliveryLead" name="ctl00$cBody$ddlDeliveryLead">
                    <option value="17">10 min</option>
                    <option value="1">15 min</option>
                    <option value="18">20 min</option>
                    <option value="2">30 min</option>
                ...
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Catering Pickup</label>
                
                <span class="rsu-info" style="display: inline;"> - Lead Time: <select id="ctl00_cBody_ddlCateringLead" name="ctl00$cBody$ddlCateringLead">
                    <option value="1">15 min</option>
                    <option value="2">30 min</option>
                    <option value="3">45 min</option>
                    <option value="4">1 hour</option>
                ...
                <br style="clear:both;"/>
                <label class="w155"><input type="checkbox" class="mid m20r" style="border:none;" /> Catering Delivery</label>
                ...
                <br />
                <br />
                <a href="#"><img src="{{$LAYOUT_HELPER_URL}}front/img/bt_conti.jpg" alt="" /></a>
            </div>